...
&\IfFileExists{./#1/textureanat_ATROPOS_GMM_PHYSICAL_VOLUME.png}{\includegraphics[width=0.1\textwidth]{./{#1}/textureanat_ATROPOS_GMM_PHYSICAL_VOLUME.png}  }{\fbox{\begin{picture}(10,10)\put(0,5){ not found } \end{picture}}}
\\ 
distance    &  entropy-1  & entropy-3 & entropy-5 & eccentricity-1  & elongation-3 & volume
\\ 
\end{tabular}           
