...
%% textureanat_ATROPOS_GMM_ECCENTRICITY.png                  
%% textureanat_ATROPOS_GMM_ELONGATION.png                    
%% textureanat_ATROPOS_GMM_PHYSICAL_VOLUME.png               
%% textureanat_ATROPOS_GMM.png                               
%% textureanat_ATROPOS_GMM_VOLUME_TO_SURFACE_AREA_RATIO.png  
%% textureanat_DENOISE.png                                   
%% textureanat_ENTROPY_RADIUS_1.png                          
%% textureanat_ENTROPY_RADIUS_3.png                       
%% textureanat_ENTROPY_RADIUS_5.png
%% textureNORMALIZED_DISTANCE.png
